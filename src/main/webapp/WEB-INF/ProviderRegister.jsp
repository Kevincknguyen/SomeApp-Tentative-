...
<div class="re">
    ...
    <p><form:errors path="provider.*"/></p>
    
    <form:form method="POST" action="/providerregistration" modelAttribute="provider">
        ...
        <p class="inputsection">
            <form:label path="licenseNumber">License:</form:label>
            <form:input class="inputbox" path="licenseNumber"/>
        </p>
        <p class="inputsection">
    ...
    <a class="button" href="/registration">Regular user?</a>
    </div>
</div>
